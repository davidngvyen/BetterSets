...
export function AppSidebar() {
    ...
    return (
        <aside className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-56 lg:flex-col">
            <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r-4 border-black bg-card px-4 pb-4">
                    ...
                    <ul role="list" className="flex flex-1 flex-col gap-y-7">
                        ...
                        <li className="mt-auto">
                            {user && (
                                <Link
                                    href="/profile"
                                    className={`group flex w-full items-center gap-x-3 border-4 border-black p-2 text-xs uppercase leading-relaxed transition-all ${isActive("/profile")
...
function NavItem({
    ...
    return (
        <li>
            <Link
                href={href}
                className={`group flex w-full items-center gap-x-2 border-4 border-black p-2 text-xs uppercase leading-relaxed transition-all ${active
